...
class EmbodiedRunner:
    ...
    def run(self):
        ...
        for _step in range(start_step, self.max_steps):
            ...
            with self.timer("step"):
                ...
                # Hook for subclasses (e.g., RM reward injection)
                self._post_rollout()
            ...
            extra_metrics = self._get_extra_metrics()
            if extra_metrics:
                self.metric_logger.log(extra_metrics, _step)
            ...
            logging_metrics.update(extra_metrics)
    ...
    def _post_rollout(self):
        """Hook called after trajectories received, before advantage computation.

        Subclasses can override to inject reward model scores, etc.
        """
        pass

    def _get_extra_metrics(self):
        """Hook for subclasses to inject extra metrics into the logging loop."""
        return {}
